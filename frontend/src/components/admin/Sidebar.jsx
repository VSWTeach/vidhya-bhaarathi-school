...
import { 
  HomeIcon, UsersIcon, CurrencyRupeeIcon, BookOpenIcon,
  DocumentTextIcon, ChartBarIcon, AcademicCapIcon,
  XMarkIcon, Bars3Icon, ArrowLeftOnRectangleIcon,
  EnvelopeIcon, UserGroupIcon, BellIcon, FolderIcon, ChatBubbleLeftRightIcon
...
const Sidebar = ({ activeModule, setActiveModule, sidebarOpen, setSidebarOpen, admin }) => {
  const menuItems = [
    ...
    { id: 'email', name: 'Email Notifications', icon: <EnvelopeIcon className="h-5 w-5" /> },
    { id: 'parent-portal', name: 'Parent Portal', icon: <UserGroupIcon className="h-5 w-5" /> },
    { id: 'whatsapp', name: 'WhatsApp', icon: <ChatBubbleLeftRightIcon className="h-5 w-5" /> },
